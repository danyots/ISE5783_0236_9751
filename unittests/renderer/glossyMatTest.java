...
public class glossyMatTest {
    ...
    public void glossyMuteTest() {
        ...
        scene.geometries.add(
                ...
                new Polygon(new Point(-75, -25, -510), new Point(-75, 60, -510), new Point(-25, 60, -510), new Point(-25, -25, -510)).setEmission(new Color(darkGray)).setMaterial(new Material().setKt(1).setKs(0.2).setKd(0.2).setShininess(60).setKB(0.7)),
                new Polygon(new Point(0, -25, -510), new Point(0, 60, -510), new Point(50, 60, -510), new Point(50, -25, -510)).setEmission(new Color(darkGray)).setMaterial(new Material().setKr(1).setKs(0.2).setKd(0.2).setShininess(60).setKB(0.4)),
