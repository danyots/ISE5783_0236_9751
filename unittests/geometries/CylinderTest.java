...
class CylinderTest {
    ...
    void testGetNormal() {
        ...
        // ensure |result| = 1
        assertEquals(1, result4.length(), 0.00000001, "Tube's normal is not a unit vector");
        //is the excepted normal
        ...
        // ensure |result| = 1
        assertEquals(1, result5.length(), 0.00000001, "Tube's normal is not a unit vector");
        //is the excepted normal
