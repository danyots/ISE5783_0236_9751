...
class CylinderTest {
     ...
     * Test method for {@link geometries.Cylinder#findGeoIntersectionsHelper(primitives.Ray)}.
     */
    @Test
    void findGeoIntersectionsHelper() {
        ...
        List<GeoPoint> result = cylinder.findGeoIntersectionsHelper(new Ray(new Point(5, 0, 0), new Vector(0, 0, 1)));
        assertNull(result, "Wrong number of points");

        //TC02 ray starts inside and parallel to the cylinder's ray
        result = cylinder.findGeoIntersectionsHelper(new Ray(new Point(2.5, 0, 1), new Vector(0, 0, 1)));
        assertEquals(1, result.size(), "Wrong number of points");
        assertEquals(List.of(new GeoPoint(cylinder,new Point(2.5, 0, 2))), result, "Bad intersection point");
        ...
        assertEquals(List.of(new GeoPoint(cylinder,new Point(2.5, 0, 0)), new GeoPoint(cylinder,new Point(2.5, 0, 2))), result, "Bad intersection point");

        //TC04 ray starts from outside and crosses the cylinder
        result = cylinder.findGeoIntersectionsHelper(new Ray(new Point(-2, 0, 0), new Vector(1, 0, 0)));
        //assertEquals(2, result.size(), "Wrong number of points");
        ...
        result = cylinder.findGeoIntersectionsHelper(new Ray(new Point(1.5, 0, 0.5), new Vector(1, 0, 0)));
        assertEquals(1, result.size(), "Wrong number of points");
        assertEquals(List.of(new GeoPoint(cylinder,new Point(3, 0, 0.5))), result, "Bad intersection points");

        //TC06 ray starts from outside the cylinder and doesn't cross the cylinder
        result = cylinder.findGeoIntersectionsHelper(new Ray(new Point(5, 0, 0), new Vector(1, 0, 0)));
        assertNull(result, "Wrong number of points");

        // =============== Boundary Values Tests ==================

        //TC10 ray is on the surface of the cylinder (not bases)
        result = cylinder.findGeoIntersectionsHelper(new Ray(new Point(3, 0, 0), new Vector(0, 0, 1)));
        assertNull(result, "Wrong number of points");

        //TC11 ray is on the base of the cylinder and crosses 2 times
        result = cylinder.findGeoIntersectionsHelper(new Ray(new Point(-1, 0, 0), new Vector(1, 0, 0)));
        assertNull(result, "Wrong number of points");
        //assertEquals(List.of(new Point3D(1,0,0), new Point3D(3,0,0)), result, "Bad intersection points");

        //TC12 ray is in center of the cylinder
        result = cylinder.findGeoIntersectionsHelper(new Ray(new Point(2, 0, 0), new Vector(0, 0, 1)));
        assertEquals(1, result.size(), "Wrong number of points");
        assertEquals(List.of(new GeoPoint(cylinder,new Point(2, 0, 2))), result, "Bad intersection points");

        //TC13 ray is perpendicular to cylinder's ray and starts from outside the tube
        result = cylinder.findGeoIntersectionsHelper(new Ray(new Point(-2, 0, 0.5), new Vector(1, 0, 0)));
        assertEquals(2, result.size(), "Wrong number of points");
        if (result.get(0).point.getX() > result.get(1).point.getX())
            result = List.of(result.get(1), result.get(0));
        assertEquals(List.of(new GeoPoint(cylinder,new Point(1, 0, 0.5)), new GeoPoint(cylinder,new Point(3, 0, 0.5))), result, "Bad intersection points");
        ...
        result = cylinder.findGeoIntersectionsHelper(new Ray(new Point(1, 0, 0.5), new Vector(1, 0, 0)));
        assertEquals(1, result.size(), "Wrong number of points");
        assertEquals(List.of(new GeoPoint(cylinder,new Point(3, 0, 0.5))), result, "Bad intersection points");

        //TC17 ray is perpendicular to cylinder's ray and starts from the surface of cylinder to outside
        result = cylinder.findGeoIntersectionsHelper(new Ray(new Point(3, 0, 0), new Vector(1, 0, 0)));
        assertNull(result, "Wrong number of points");

        //TC18 ray starts from the surface to outside
        result = cylinder.findGeoIntersectionsHelper(new Ray(new Point(3, 0, 0), new Vector(1, 1, 1)));
        assertNull(result, "Wrong number of points");

        //TC20 ray starts from the center
        result = cylinder.findGeoIntersectionsHelper(new Ray(new Point(2, 0, 0), new Vector(1, 0, 1)));
        assertEquals(1, result.size(), "Wrong number of points");
        assertEquals(List.of(new GeoPoint(cylinder,new Point(3, 0, 1))), result, "Bad intersection point");
        ...
        result = cylinder.findGeoIntersectionsHelper(new Ray(new Point(3, 0, 1), new Vector(0, 0, 1)));
        assertNull(result, "Wrong number of points");

        //TC24 ray is on the surface starts at top's base
        result = cylinder.findGeoIntersectionsHelper(new Ray(new Point(3, 0, 2), new Vector(0, 0, 1)));
        assertNull(result, "Wrong number of points");
        ...
        result = cylinder.findGeoIntersectionsHelper(new Ray(new Point(3, 0, 0.5), new Vector(-1, 0, 0)));
        assertEquals(1, result.size(), "Wrong number of points");
        assertEquals(List.of(new GeoPoint(cylinder,new Point(1, 0, 0.5))), result, "Bad intersection point");
